...
bench$miss <- as.tibble(complete(bench$temp$mi.temp, 2)) # Chosen as a conservative value, which is also consistent with outputs of other imputation methods (e.g. Bayes)
